...
const ComputerScience = () => {
    ...
    const handleComputerScienceClick = () => {
        if (country) {
            switch (country) {
                case 'Canada':
                    router.push('/ca/online-computer-science-tuition');
                    break;
                case 'Australia':
                    router.push('/au/online-computer-science-tuition');
                    break;
                // Add more cases as needed...
                default:
                    router.push('/online-computer-science-tuition');
            }
        } else {
            router.push('/online-computer-science-tuition');
        }
    ...
    return (
        <>
            ...
            <div className="p-6 max-w-[90%] mx-auto font-sans bg-white shadow-md rounded-lg">
                <section className="relative bg-cover bg-center h-40 rounded-md md:h-72 text-white flex items-center justify-center" style={{ backgroundImage: 'url("/Images/computer_science.jpg")' }}>
                ...
                <section className="mb-[70px]">
                    <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-center text-gray-700">How Our Online Computer Science Tuition Works</h2>
                    <p className="mb-9 text-center text-gray-700">
                        Our personalized approach to computer science tutoring includes:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Steps for online tuition */}
                        <div className="relative p-6 bg-blue-50 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            <div className="absolute top-[-20px] left-0 w-12 h-12 bg-blue-600 text-white font-bold text-2xl rounded-full flex items-center justify-center shadow-md">
                                1
                            </div>
                            ...
                            <p className="text-gray-600">
                                We begin by assessing the student’s current knowledge to identify strengths and areas for improvement.
                            </p>
                        </div>
                        <div className="relative p-6 bg-blue-50 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            <div className="absolute top-[-20px] left-0 w-12 h-12 bg-blue-600 text-white font-bold text-2xl rounded-full flex items-center justify-center shadow-md">
                            ...
                            <p className="text-gray-600">
                                A customized learning plan is developed based on the student's goals, whether mastering basics or excelling in exams.
                            </p>
                        </div>
                    </div>
                </section>
