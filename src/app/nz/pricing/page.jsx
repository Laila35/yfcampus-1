  ...
  return (
    <>
      <head>
        ...
        {/* Canonical URL */}
        <link aria-label="pricing" rel="canonical" href="https://yfcampus.com/pricing" />
    ...
    {[
      {
        ...
        priceNZD: "10.86 NZD/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        priceNZD: "15.20 NZD/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        priceNZD: "19.54 NZD/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">32.57 NZD/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">43.42 NZD/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">65.14 NZD/hour</span><br />
        </div>
      </div>
    </div>
</div>
