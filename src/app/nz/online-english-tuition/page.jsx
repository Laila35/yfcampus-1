...
const NzEnglish = () => {
  ...
  const topics = [
    {
      ...
      description: 'Improve reading skills, analysis, and critical thinking for NCEA exams.',
    },
    {
      image: '/Images/writing.webp',
      title: 'Writing Skills',
      description: 'Enhance writing techniques, including essays, reports, and creative writing tasks for NCEA.',
    },
    {
    ...
    },
    {
      ...
      description: 'Study key texts for NCEA Level 1-3, focusing on analysis, themes, and character exploration.',
    },
  ];
  ...
  const gradeLevels = [
    {
      ...
      description: 'Focus on building strong reading, writing, and grammar skills, aligned with the New Zealand Curriculum.',
    },
    {
      title: 'Intermediate (Years 7-8)',
      description: 'Support for students preparing for NCEA Level 1, focusing on reading comprehension and writing skills.',
    },
    {
      title: 'Secondary School (Years 9-13)',
      description: 'Advanced support for NCEA Level 1-3, focusing on English literature, essay writing, and exam preparation.',
    },
  ];
  useEffect(() => {
    if (country) {
  ...
  return (
    <>
      <head>
        <title>
          Online English Tuition in New Zealand | NCEA English Tutors | YFC
        </title>
        <meta
          name="description"
          content="Looking for expert online English tuition in New Zealand? YFC offers personalized tutoring in reading, writing, grammar, and literature for all grades, including NCEA exams. Free trial available!"
        />
        <meta
          name="keywords"
          content="online English tuition New Zealand, NCEA English tutoring, NCEA Level 1-3 English tutors, online reading tutoring New Zealand, NCEA English exam preparation, New Zealand English tutors"
        />
        <meta
          property="og:title"
          content="Online English Tuition in New Zealand | NCEA English Tutors | YFC"
        />
        <meta property="og:url" content="https://yfcampus.com/nz/online-english-tuition/" />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href="https://yfcampus.com/nz/online-english-tuition/"
          title="online english Tuition"
          aria-label="online english Tuition"
        />
        <link
          rel="alternate"
          href="https://yfcampus.com/nz/online-maths-tuition/"
          title="Maths Tuition"
          aria-label="Maths Tuition"
        />
        <link
          rel="alternate"
          href="https://yfcampus.com/nz/online-science-tuition/"
        ...
        <div className="p-6 max-w-[90%] mx-auto font-sans bg-white shadow-md rounded-lg">
          <section className="relative bg-cover bg-center h-40 rounded-md md:h-72 text-white flex items-center justify-center" style={{ backgroundImage: 'url("/Images/english.webp")' }}>
            ...
            <h1 className="relative text-2xl md:text-4xl font-bold text-center px-4">
              Online English Tuition for New Zealand Students | NCEA Exam Focused Tutoring
            </h1>
          </section>
          ...
          <section className="mb-8 p-4">
            ...
            <p className="mt-2 text-gray-700">
              At YFC, we provide comprehensive online English tuition for students in New Zealand, following the New Zealand Curriculum. Our expert tutors offer personalized support in reading, writing, grammar, and literature, helping students excel in NCEA Level 1-3 exams and develop essential English skills.
            </p>
          </section>
          ...
          <section className="mb-[70px]">
            ...
            <p className="mb-9 text-center text-gray-700">
              Our English tuition in New Zealand covers all essential skills across various year levels, including:
            </p>
          ...
          <section className="mb-[70px]">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-center text-teal-700">
              How Our New Zealand Online English Tuition Works
            </h2>
            <p className="mb-9 text-center text-gray-700">
              Discover a personalized and effective approach to mastering English with our online tuition for students in New Zealand.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="relative p-6 bg-teal-50 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <p className="text-gray-600">
                  We assess each student’s current level to identify strengths and areas for improvement.
                </p>
              </div>
              ...
              <div className="relative p-6 bg-teal-50 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <p className="text-gray-600">
                  A tailored learning plan is developed to help the student excel in reading, writing, and literature.
                </p>
              </div>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We provide focused preparation for New Zealand’s key exams:
                </p>
                <p className="text-gray-700">
                  NCEA Level 1-3 English: Comprehensive support for students preparing for NCEA English exams, focusing on literature, writing, and comprehension.
                </p>
              </div>
              ...
              <div className="lg:w-1/2 grid grid-cols-2 gap-4 p-6">
                ...
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 1 English</h4>
                  <p className="text-gray-700">Support for students preparing for NCEA Level 1 English exams.</p>
                </div>
                {/* Box 2 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 2 English</h4>
                  <p className="text-gray-700">Focused assistance for NCEA Level 2 English exam preparation.</p>
                </div>
                {/* Box 3 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 3 English</h4>
                  <p className="text-gray-700">Comprehensive support for NCEA Level 3 English exams.</p>
                </div>
                {/* Box 4 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">Mock Exams</h4>
                  <p className="text-gray-700">Regular mock exams to assess readiness for NCEA English exams.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="flex overflow-x-auto justify-center space-x-4 snap-x snap-mandatory">
              ...
              >
                <TestimonialCard
                  text="Thanks to YFC’s tutoring, my son improved his NCEA English scores significantly. The tutor was great at explaining things clearly."
                  author="Zoe, Parent"
              ...
              >
                <TestimonialCard
                  text="YFC helped me understand literature much better for my NCEA exams. I scored higher than I expected!"
          ...
          <CallToAction
            heading="Prepare for NCEA Success with YFC!"
            description="Contact us today to book a free trial session and help your child succeed in English."
