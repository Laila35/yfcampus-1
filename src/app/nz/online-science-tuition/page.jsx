...
const NzScience = () => {
  ...
  const gradeLevels = [
    ...
    },
    {
      ...
      description: 'Advanced topics and exam preparation for NCEA Levels 1-3, ensuring students are ready for university-level science.',
    },
    {
  ...
  return (
    <>
      <head>
        <title>
          Online Science Tuition in New Zealand | NCEA Science Tutors for Grades 1-12 | YFC
        </title>
        <meta
          name="description"
          content="Looking for expert online science tuition in New Zealand? YFC offers personalized tutoring in Physics, Chemistry, and Biology for NCEA students. Free trial available!"
        />
        <meta
          name="keywords"
          content="online science tuition New Zealand, NCEA science tutoring, physics tutoring New Zealand, chemistry tutoring New Zealand, biology tutors New Zealand"
        />
        <meta
          property="og:title"
          content="Online Science Tuition in New Zealand | Expert Science Tutors | YFC"
        />
        <meta
          property="og:url"
          content="https://yfcampus.com/online-science-tuition-new-zealand/"
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Looking for personalized science tutoring in New Zealand? YFC offers specialized support for NCEA exam preparation. Get a free trial today!"
        />
        <link
          rel="canonical"
          href="https://yfcampus.com/online-science-tuition-new-zealand/"
        ...
        <div className="p-6 max-w-[90%] mx-auto font-sans bg-white shadow-md rounded-lg">
          <section className="relative bg-cover bg-center h-40 rounded-md md:h-72 text-white flex items-center justify-center" style={{ backgroundImage: 'url("/Images/science_banner.webp")' }}>
            ...
            <h1 className="relative text-2xl md:text-4xl font-bold text-center px-4">
              Online Science Tuition for New Zealand Students | NCEA Science Tutoring and More
            </h1>
          </section>
          ...
          <section className="mb-8 p-4">
            ...
            <p className="mt-2 text-gray-700">
              At Your Future Campus (YFC), we provide comprehensive online science tuition for students across New Zealand, aligned with the New Zealand Curriculum and NCEA standards. Whether your child is in primary school, preparing for intermediate science courses, or aiming for excellence in NCEA exams, our expert tutors are here to help. With flexible online sessions, New Zealand students can excel in science from the comfort of their homes.
            </p>
          </section>
          ...
          <section className="mb-[70px]">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-center text-teal-700">
              How Our New Zealand Online Science Tuition Works
            </h2>
            <p className="mb-9 text-center text-gray-700">
              Discover a personalized and effective approach to mastering science with our online tuition for students in New Zealand.
            </p>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We specialize in preparing New Zealand students for key science exams:
                </p>
                <p className="text-gray-700">
                  NCEA Level 1 Science: Foundational topics including physics, chemistry, and biology.
                </p>
                <p className="text-gray-700 mt-2">
                  NCEA Level 2 Science: Intermediate topics including chemistry principles, physics concepts, and biological systems.
                </p>

                <p className="text-gray-700 mt-2">
                  NCEA Level 3 Science: Advanced topics in physics, chemistry, and biology, preparing students for university entry.
                </p>
              </div>
              ...
              <div className="lg:w-1/2 grid grid-cols-2 gap-4 p-6">
                ...
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 1 Science</h4>
                  <p className="text-gray-700">Foundational topics including physics, chemistry, and biology.</p>
                </div>
                {/* Box 2 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 2 Science</h4>
                  <p className="text-gray-700">Intermediate topics like advanced algebra, trigonometry, and chemistry principles.</p>
                </div>
                {/* Box 3 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">NCEA Level 3 Science</h4>
                  <p className="text-gray-700">Advanced topics in physics, chemistry, and biology, preparing students for university entry.</p>
                </div>
                {/* Box 4 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
          ...
          <section className="mb-8">
            ...
            <div className="flex overflow-x-auto justify-center space-x-4 snap-x snap-mandatory">
              ...
              >
                <TestimonialCard
                  text="YFC’s science tutoring helped my son excel in his NCEA Level 2 exams. The personalized approach made all the difference!"
                  author="Aroha, Parent"
              ...
              >
                <TestimonialCard
                  text="Thanks to YFC, I gained a deeper understanding of biology and achieved top marks in my NCEA Level 3 exam."
                  author="Liam, Student"
