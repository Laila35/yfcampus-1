...
const Custom404 = () => {
    return (
        <>
            <head>
                <title>Page Not Found - 404 Error | YFCampus Online Academy</title>
                <meta
                    name="description"
                    content="Oops! The page you’re looking for doesn’t exist. Please check the URL or return to the homepage of Yfcampus."
                />
            ...
            <div className="flex flex-col items-center justify-start min-h-screen bg-teal-50 text-center pt-20 px-4">
                ...
                <Link aria-label='Go to home' href="/" className="mt-4 px-4 py-2 text-white bg-teal-500 rounded hover:bg-teal-600 transition duration-300">
                    Go to Home
                </Link>
            </div>
