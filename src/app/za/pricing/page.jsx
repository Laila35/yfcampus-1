  ...
  return (
    <>
      <head>
        ...
        {/* Canonical URL */}
        <link aria-label="yfcampus pricing" rel="canonical" href="https://yfcampus.com/pricing" />
    ...
    {[
      {
        ...
        priceZAR: "113.49 ZAR/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        priceZAR: "158.49 ZAR/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        priceZAR: "204.28 ZAR/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">340.47 ZAR/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">453.96 ZAR/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">680.94 ZAR/hour</span><br />
        </div>
      </div>
    </div>
</div>
