  ...
  return (
    <>
      <head>
        ...
        {/* Canonical URL */}
        <link aria-label="pricing yfcampus" rel="canonical" href="https://yfcampus.com/pricing" />
    ...
    {[
      {
        ...
        pricePHP: "379.08 PHP/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        pricePHP: "530.71 PHP/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        pricePHP: "683.54 PHP/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">1,137.24 PHP/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">1,513.92 PHP/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">2,270.49 PHP/hour</span><br />
        </div>
      </div>
    </div>
</div>
