...
const CaScience = () => {
  ...
  const gradeLevels = [
    ...
    },
    {
      ...
      description: 'Advanced topics and exam preparation for Provincial Final Exams, High School Graduation Assessments, and university entrance requirements.',
    },
  ];
  ...
  return (
    <>
      <head>
        <title>
          Online Science Tuition in Canada | Expert Science Tutors for Grades 1-12 | YFC
        </title>
        <meta
          name="description"
          content="Looking for expert online science tuition in Canada? YFC offers personalized tutoring in Physics, Chemistry, and Biology for all grade levels. Get a free trial today!"
        />
        <meta
          name="keywords"
          content="online science tuition Canada, physics tutoring Canada, chemistry tutoring Canada, biology tutors Canada"
        />
        <meta
          property="og:title"
          content="Online Science Tuition in Canada | Expert Science Tutors | YFC"
        />
        <meta property="og:url" content="https://yfcampus.com/online-science-tuition-canada/" />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Looking for personalized science tutoring in Canada? YFC offers specialized support for provincial exams and high school science preparation. Get a free trial today!"
        />
        <link
                aria-label="online science tution canada"

          rel="canonical"
          href="https://yfcampus.com/online-science-tuition-canada/"
        />
        <link
        ...
        <img src="URL_to_the_image.jpg" alt="Student learning biology through online science tutoring in Canada" />
        ...
        <div className="p-6 max-w-[90%] mx-auto font-sans bg-white shadow-md rounded-lg">
          <section className="relative bg-cover bg-center h-40 rounded-md md:h-72 text-white flex items-center justify-center" style={{ backgroundImage: 'url("/Images/science_banner.webp")' }}>
            ...
            <h1 className="relative text-2xl md:text-4xl font-bold text-center px-4">
              Online Science Tuition for Canadian Students | Physics, Chemistry, and Biology Tutoring
            </h1>
          </section>
          ...
          <section className="mb-8 p-4">
            ...
            <p className="mt-2 text-gray-700">
              At Your Future Campus (YFC), we provide specialized online science tuition for students across Canada, aligned with the Canadian Provincial Curricula. Whether your child is in elementary school, preparing for provincial exams, or aiming for top scores in high school science, our expert tutors are here to guide them every step of the way. With flexible online sessions, Canadian students can excel in science from the comfort of their homes.
            </p>
          </section>
          ...
          <section className="mb-[70px]">
            ...
            <p className="mb-9 text-center text-gray-700">
              Our Canada science tuition covers all essential topics across various grade levels, including:
            </p>
          ...
          <section className="mb-[70px]">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-center text-teal-700">
              How Our Canadian Online Science Tuition Works
            </h2>
            <p className="mb-9 text-center text-gray-700">
              Discover a personalized and effective approach to mastering science with our online tuition for students in Canada.
            </p>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We specialize in preparing Canadian students for key science exams:
                </p>
                <p className="text-gray-700">
                  EQAO Science (Grades 3, 6, 9): Focused tutoring to help students perform well in EQAO assessments.
                </p>
                <p className="text-gray-700 mt-2">
                  Provincial Final Exams: Comprehensive support for high school science exams across various provinces.
                </p>
                <p className="text-gray-700 mt-2">
                  High School Graduation Exams: Preparation for high school graduation assessments, ensuring students are ready for post-secondary education.
                </p>
              </div>
              ...
              <div className="lg:w-1/2 grid grid-cols-2 gap-4 p-6">
                ...
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">EQAO Science</h4>
                  <p className="text-gray-700">Focused tutoring to help students perform well in EQAO assessments.</p>
                </div>
                {/* Box 2 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">Provincial Final Exams</h4>
                  <p className="text-gray-700">Comprehensive support for high school science exams across various provinces.</p>
                </div>
                {/* Box 3 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
                  <h4 className="text-lg font-semibold text-teal-700 mb-2">Graduation Exam Prep</h4>
                  <p className="text-gray-700">Preparation for high school graduation assessments, ensuring readiness for post-secondary education.</p>
                </div>
                {/* Box 4 */}
                <div className="border border-teal-600 p-4 rounded-lg text-center bg-white shadow-lg hover:bg-teal-50 transition ease-in-out">
          ...
          <section className="mb-8">
            ...
            <div className="flex overflow-x-auto justify-center space-x-4 snap-x snap-mandatory">
              ...
              >
                <TestimonialCard
                  text="YFC’s science tutoring helped my son excel in his Grade 9 EQAO exam. His understanding of biology improved dramatically!"
                  author="Laura, Parent"
                  image="/Images/jame.webp" // Replace with the actual image URL or path for boy
                />
              </div>
              ...
              >
                <TestimonialCard
                  text="Thanks to YFC, I achieved top marks in my Provincial Final Exams for chemistry. The tutors made complex concepts easy to grasp."
                  author="Ethan, Student"
                  image="/Images/emma.webp" // Replace with the actual image URL or path for girl
                />
              </div>
            </div>
          </section>
