  ...
  return (
    ...
    {[
      {
        ...
        priceCAD: "9.04 CAD/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        priceCAD: "12.65 CAD/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        priceCAD: "16.26 CAD/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">27.11 CAD/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">36.14 CAD/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">54.21 CAD/hour</span><br />
        </div>
      </div>
    </div>
</div>
