  ...
  return (
    ...
    {[
      {
        ...
        priceMYR: "28.28 MYR/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        priceMYR: "39.59 MYR/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        priceMYR: "50.90 MYR/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">84.83 MYR/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">113.10 MYR/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">169.35 MYR/hour</span><br />
        </div>
      </div>
    </div>
</div>
