  ...
  return (
    ...
    {[
      {
        ...
        priceAUD: "9.82 AUD/hour",
      },
      {
        title: "Secondary Tuition (Year 7-10)",
        priceAUD: "13.74 AUD/hour",
      },
      {
        title: "GCSE Tuition (Year 11+)",
        priceAUD: "17.67 AUD/hour",
      },
    ].map((tuition) => (
    ...
    <div className="border-2 border-teal-600 rounded-lg p-6 md:p-12 w-full lg:w-[44%] xl:w-[30%] 2xl:w-[25%] shadow-lg">
      ...
      <div className="text-right text-gray-800 font-medium text-[16px] lg:text-[18px]">
        <div className="mt-2">
          Primary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">29.45 AUD/hour</span><br />
        </div>
        <div className="mt-2">
          Secondary: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">39.26 AUD/hour</span><br />
        </div>
        <div className="mt-2">
          GCSE: <span className="text-[#007B7B] bg-yellow-200 px-2 py-1 rounded">58.89 AUD/hour</span><br />
        </div>
      </div>
    </div>
</div>
