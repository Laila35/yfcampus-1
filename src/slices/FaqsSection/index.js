/**
 * @typedef {import("@prismicio/client").Content.FaqsSectionSlice} FaqsSectionSlice
 * @typedef {import("@prismicio/react").SliceComponentProps<FaqsSectionSlice>} FaqsSectionProps
 * @type {import("react").FC<FaqsSectionProps>}
 */
  "use client";
 import {
   Disclosure,
...
const FaqsSection = ({ slice }) => {
    const heading=slice.primary.heading
    const{faqs}=slice.primary
    return (
        <section
