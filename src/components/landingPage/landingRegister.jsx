...
const LandingRegister = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="font-semibold text-[18px] mt-2 md:text-lg lg:text-[28px] text-teal-600 mb-8 text-center">
  ...
  type="submit"
  disabled={loading}
  className="w-full p-3 font-semibold bg-gradient-to-r from-[#1E8C8C] to-[#3CB371] text-white rounded-lg shadow-lg hover:shadow-2xl hover:bg-gradient-to-r hover:from-[#3CB371] hover:to-[#1E8C8C] transition-all duration-500 ease-in-out transform hover:-translate-y-0.5"
>
