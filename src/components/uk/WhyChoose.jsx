...
const quoteAuthor=" – Director, Your Future Campus UK"
  ...
  className="relative mt-12 py-16 bg-gray-50 overflow-hidden"
>
  {/* Background Accent */}
  ...
  <div className="max-w-7xl mx-auto px-6 md:px-[3.7rem] text-center">
    ...
    <div className="mt-16 mx-auto max-w-3xl relative">
      <div className="relative rounded-3xl border border-teal-100 bg-gradient-to-br from-white to-teal-50 shadow p-8">
        <Quote
